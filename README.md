# Node Dungeon Router
Sorts nodes in blender with A* algorithm. Settings can be adjusted. Project is vibe-coded, so **do not** expect **any** updates. Created for my personal use initially and i made it out public. Feel free to use. :)
